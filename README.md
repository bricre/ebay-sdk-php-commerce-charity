# (Unofficial) eBay API client (PHP) - Commerce / Charity
...
Please refer to [eBay's documentation](https://developer.ebay.com/api-docs/commerce/charity/overview.html) for detailed API
...
Starting from version v1.2.0, this project will match according eBay API's versioning. Should you found a matching 
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/commerce/charity/v1/',
        'headers'=>[
